...
$string['modulename_help'] = 'Используйте модуль Zuzan для видеоконференций. Учетные данные пользователей moodle будут использованы в конференциях.';
...
$string['jitsi:view'] = 'Смотреть Zuzan';
$string['jitsiname'] = 'Session name';
$string['jitsi'] = 'Zuzan';
$string['pluginadministration'] = 'Zuzan администрирование';
