...
$string['modulename_help'] = 'Используйте модуль Zuzan Meet для видеоконференций. Учетные данные пользователей moodle будут использованы в конференциях.';
$string['jitsi:addinstance'] = 'Добавить новую конференцию';
$string['jitsi:moderation'] = 'Zuzan Meet Moderation';
$string['jitsi:sharedesktop'] = 'Показать рабочий стол';
$string['jitsi:view'] = 'Смотреть Zuzan Meet';
$string['jitsiname'] = 'Session name';
$string['jitsi'] = 'Zuzan Meet';
$string['pluginadministration'] = 'Zuzan Meet администрирование';
$string['pluginname'] = 'Zuzan Meet';
$string['instruction'] = 'Нажмите кнопку для доступа';
$string['access'] = 'Доступ';
$string['calendarstart'] = 'Конференция начнется \'{$a}\' ';
$string['allow'] = 'Начать конференцию';
$string['nostart'] = 'Конференция еще не началась. Доступ будет открыт за {$a} минут до начала';
...
$string['noviewpermission'] = 'У вас нет доступа для доступа к этой конференции';
$string['minpretime'] = 'Минут до доступа';
$string['help'] = 'Помощь';
$string['helpex'] = 'Инструкция';
...
$string['streamingbuttonex'] = 'Show streaming option. (only for moderators)';
